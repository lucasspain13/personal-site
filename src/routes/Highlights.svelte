	...
	const categories = [
		{
			...
			items: [
				...
				},
				{
					...
					value: '5+',
					description: 'AWS, AI & Cloud Technologies',
					icon: `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-10 h-10"><path stroke-linecap="round" stroke-linejoin="round" d="M17.25 6.75 22.5 12l-5.25 5.25m-10.5 0L1.5 12l5.25-5.25m7.5-3-4.5 16.5" /></svg>`,
		...
		},
		{
			...
			items: [
				...
				},
				{
					...
					value: 'Advanced',
					description: 'OpenSearch, Chroma, FAISS',
					...
					color: 'bg-primary-focus text-white'
				},
				{
					title: 'Multi-Agent Systems',
					value: 'Specialist',
					description: 'Building collaborative AI systems',
			...
			items: [
				{
					...
					value: '12+',
					description: 'Web, Mobile & AI Applications',
					...
					color: 'bg-secondary-focus text-white'
				},
				{
				...
				},
				{
					...
					value: '11',
					description: 'Awards & Acknowledgements',
